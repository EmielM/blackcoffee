...
(function() {
  var Lexer, Macro, SourceMap, compile, formatSourcePosition, fs, getSourceMap, helpers, lexer, parser, path, sourceMaps, vm,
  ...
  Error.prepareStackTrace = function(err, stack) {
    ...
    frames = (function() {
      ...
      for (_i = 0, _len = stack.length; _i < _len; _i++) {
        frame = stack[_i];
        if ((_ref = frame.getFunction()) != null ? _ref.stopStackTrace : void 0) {
          break;
        }
