...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Code, CodeFragment, Comment, Existence, Extends, For, HEXNUM, IDENTIFIER, IDENTIFIER_STR, IS_REGEX, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, NUMBER, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, addLocationDataFn, cloneNode, compact, createObject, del, ends, extend, flatten, fragmentsToText, isLiteralArguments, isLiteralThis, last, locationDataToString, merge, multident, parseNum, some, starts, throwSyntaxError, unfoldSoak, utility, walk, walkArray, _ref, _ref1,
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.subst = function(replacements) {
      var ast, changeNode;
      changeNode = function(n) {
        var tmp, _ref2, _ref3, _ref4;
        if (tmp = replacements[(_ref2 = n.base) != null ? _ref2.value : void 0]) {
          n.base = cloneNode(tmp);
        } else if ((tmp = replacements[(_ref3 = n.name) != null ? _ref3.value : void 0])) {
          if (!(tmp = (_ref4 = tmp.base) != null ? _ref4.value : void 0)) {
  ...
  walkArray = function(array, visit) {
    var i, item, res;
    i = 0;
    while (item = array[i++]) {
